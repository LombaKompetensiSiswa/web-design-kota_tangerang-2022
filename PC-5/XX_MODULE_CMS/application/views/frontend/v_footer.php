...
<section class="paralax-mf footer-paralax bg-image sect-mt4 route" style="background-image: url(assets_frontend/img/counters-bg.jpg)">
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="copyright-box">
            ...
            <div class="credits">
              Beli Ticket Di <a href="www.ticketmaster.com">Ticket Master</a>
            </div>
          </div>
        </div>
      </div>
