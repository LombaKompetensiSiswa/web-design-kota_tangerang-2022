...
<head>
  ...
  <title>Website Saya | Log in</title>
...
<body class="hold-transition login-page">
  <div class="login-box">
    <div class="login-logo">
      <a href="<?php echo base_url(); ?>assets/index2.html"><b>Website</b>Saya</a>
    </div>
    <!-- /.login-logo -->
    ...
    <div class="login-box-body">
      <p class="login-box-msg">kamu login dulu ya</p> <b>
      <p class="login-box-msg">iya kamu</p> <b>
