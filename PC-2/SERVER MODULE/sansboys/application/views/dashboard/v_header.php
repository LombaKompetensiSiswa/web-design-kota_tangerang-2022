  ...
  <div class="wrapper">
    ...
    <header class="main-header">      
      <a href="<?php echo base_url(); ?>" class="logo">
        ...
        <span class="logo-lg"><b>Aji</b>Website</span>
      </a>
          ...
          <ul class="nav navbar-nav">
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="<?php echo base_url(); ?>assets_frontend/img/fadli.jpg" class="user-image" alt="User Image">
                <span class="hidden-xs">HAK AKSES : <b><?php echo $this->session->userdata('level') ?></b></span>
              </a>
              <ul class="dropdown-menu">
                <li class="user-header">
                  <img src="<?php echo base_url(); ?>>assets_frontend/img/fadli.jpg" class="img-circle" alt="User Image">
                  <p>
